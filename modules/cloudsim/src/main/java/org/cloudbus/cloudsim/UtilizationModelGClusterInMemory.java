...
public class UtilizationModelGClusterInMemory implements UtilizationModel{
	 ...
	 */
	public UtilizationModelGClusterInMemory(String inputPath, double schedulingInterval)
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public UtilizationModelGClusterInMemory(String inputPath, double schedulingInterval, int dataSamples)
			throws NumberFormatException,
			IOException {
		setSchedulingInterval(schedulingInterval);
